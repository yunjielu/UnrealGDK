...
void FSpatialGDKEditorToolbarCommands::RegisterCommands()
{
	...
	UI_COMMAND(OpenBotConfigurationWindowAction, "Bot Deployment", "Opens a configuration menu for the bot deployments.", EUserInterfaceActionType::Button, FInputGesture());
}
